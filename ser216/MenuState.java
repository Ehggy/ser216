...
public class MenuState extends State{
	...
	public MenuState(StateManager manager, SpriteBatch batch){
		...
		playUp = new Texture(Gdx.files.internal("play_up.png"));
		playDown = new Texture(Gdx.files.internal("play_down.png"));
		quitUp = new Texture(Gdx.files.internal("quit_up.png"));
		quitDown = new Texture(Gdx.files.internal("quit_down.png"));
		aboutUp = new Texture(Gdx.files.internal("about_up.png"));
		aboutDown = new Texture(Gdx.files.internal("about_down.png"));
